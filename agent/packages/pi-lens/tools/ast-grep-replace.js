...
import { classifyAstGrepError, logAstGrepToolEvent, } from "../clients/ast-grep-tool-logger.js";
        ...
        async execute(_toolCallId, params, _signal, _onUpdate, ctx) {
            ...
            if (hasStructuralIntent({ insideKind, hasKind, follows, precedes })) {
                ...
                if (ruleResult.error) {
                    ...
                    return { content: [{ type: "text", text: `Error: ${ruleResult.error}` }], isError: true, details: {} };
                }
